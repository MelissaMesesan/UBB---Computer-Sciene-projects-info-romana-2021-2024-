...
def travelingSalesman(graph, population_size=500, no_of_generations=100, evaluation_function=calculateDistanceCyclic,
...
if __name__ == "__main__":
    graph = readGraphFromFile("data/easy01.txt")
