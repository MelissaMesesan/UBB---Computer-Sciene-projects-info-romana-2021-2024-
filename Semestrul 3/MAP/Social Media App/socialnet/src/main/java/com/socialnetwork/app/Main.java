...
public class Main extends Application {
    private final static String url="jdbc:postgresql://localhost:5432/social_media";
    private final static String username="postgres";
    private final static String password="teprindeu";
    ...
    public void start(Stage stage) throws IOException {
        ...
        stage.setTitle("Giraffe's network");
